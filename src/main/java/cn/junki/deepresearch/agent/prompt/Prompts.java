package cn.junki.deepresearch.agent.prompt;
...
public interface Prompts {
        String AGENT_BASE_PROMPT = "In order to complete the objective that the user asks of you, you have access to a number of standard tools.";
